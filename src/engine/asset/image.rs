...
/// and downscaled into responsive width variants. The smaller of the input and
/// the output always wins: re-encoding an already-tight file can grow it.
...
impl Raster {
    ...
    /// and the result is smaller. Unconfigured for the format, they pass
    /// through as they are.
...
/// so the orientation is baked into the pixels first.
