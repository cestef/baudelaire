...
//! page to its template and [`layout`] renders it, [`sections`] writes the site
//! tree those templates import, [`card`] compiles the same
...
//! parallel pool; [`prepare`] and [`sections`] derive from the whole page set
