...
/// A shape is a field set and its slots.
#[test]
...
/// A slot pointing at a field nobody declares would render every entity without
/// it, so it is refused at the line that wrote it.
#[test]
